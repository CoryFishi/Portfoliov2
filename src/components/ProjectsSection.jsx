...
export default function ProjectsSection({ projectsRef }) {
  return (
    <div
      ref={projectsRef}
      className="w-full h-full flex flex-col font-robot overflow-hidden justify-center items-center"
    >
      {/* Header */}
      <div className="mt-40">
        ...
        {/* Select Projects */}
        <div className="w-full hidden flex-col h-screen xl:flex px-16">
              ...
              <div className="w-full p-2 m-3 rounded text-left">
                ...
                <div className="mt-5 flex gap-3">
                  ...
                  <button
                    ...
                    onClick={() =>
                      window.open(
                        "https://github.com/CoryFishi/NewPMS",
                        "_blank"
                      )
                    }
                  >
          ...
          <div
            ...
            className="w-full grid grid-cols-4 gap-5 rounded px-60 mt-2 text-center"
          >
            {/* Project 1 Option */}
            <div className="group hover:bg-gray-300 dark:hover:bg-zinc-800 p-2 hover:scale-105 rounded transition duration-300 ease-in-out transform select-none hover:cursor-pointer">
            ...
            <div
              title="Click to see details"
              className="group hover:bg-gray-300 p-2 dark:hover:bg-zinc-800 hover:scale-105 rounded transition duration-300 ease-in-out transform select-none hover:cursor-pointer"
            >
              <div className="flex items-center justify-center relative">
                <img
                  src={project2Static}
