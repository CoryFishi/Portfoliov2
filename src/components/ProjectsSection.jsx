  ...
  return (
    ...
    >
      ...
      <div className="w-full flex flex-col justify-evenly">
        <div className="group w-full flex justify-evenly mx-36">
        ...
        <div className="w-full grid grid-cols-4 gap-2 rounded text-center p-2">
          <div className="group hover:bg-gray-400 p-4 m-3 hover:scale-105 rounded transition duration-300 ease-in-out transform select-none hover:cursor-pointer">
          ...
          <div className="group hover:bg-gray-400 p-4 m-3 hover:scale-105rounded transition duration-300 ease-in-out transform select-none hover:cursor-pointer">
            <div className="flex items-center justify-center relative">
              <img
                src={project2Static}
                alt="Default Image"
